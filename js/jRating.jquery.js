...
(function ($) {
    $.fn.jRating = function (op) {
        var defaults = {
            /** String vars **/
            bigStarsPath: 'style/icons/stars.png', // path of the icon stars.png
            smallStarsPath: 'style/icons/small.png', // path of the icon small.png
        ...
        if (this.length > 0) return this.each(function () {
            ...
            if (!jDisabled) $(this).unbind().bind({
                ...
                mousemove: function (e) {
                    ...
                    if (opts.showRateInfo) $("p.jRatingInfos")
                        .css({
                        left: (e.pageX + opts.rateInfosX)
                    })
