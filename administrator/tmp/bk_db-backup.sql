...
CREATE TABLE `clients` (
  ...
  `distance_range` int(11) DEFAULT '5',
  `user_login_required` int(11) DEFAULT NULL,
  `show_wait_time` int(11) DEFAULT NULL,
  `choose_delivery_method` int(11) DEFAULT NULL,
  `enable_order` int(11) DEFAULT NULL,
  `lazy_required` int(11) DEFAULT NULL,
  `show_rating` int(11) DEFAULT NULL,
  `enable_print` int(11) DEFAULT NULL,
  `descripion` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO clients VALUES(1001,"L'incontro","0524574479","Viale Agostino Berenini 43039 Salsomaggiore Terme Parma",NULL,NULL,NULL,NULL,NULL,"44.814815","9.982874",5,0,1,0,1,0,1,1,NULL);
INSERT INTO clients VALUES(1002,"L'incontro","0524574479","Viale Agostino Berenini 43039 Salsomaggiore Terme Parma",NULL,NULL,NULL,NULL,NULL,"44.814815","9.982874",5,1,1,1,1,1,1,0,"Orario di apertura 09:00-15:00 17:00-24:00");
...
CREATE TABLE `menurows` (
  ...
  `qty_min` int(11) DEFAULT '1',
  `qty_max` int(11) DEFAULT '20',
  `qty_step` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `orderrows` (
  ...
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `client_visibility` int(11) DEFAULT '1',
  `note` longtext,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `row_id` FOREIGN KEY (`row_id`) REFERENCES `menurows` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `requests` (
  ...
  `escapee` int(10) unsigned NOT NULL,
...
CREATE TABLE `supplementgroupc` (
  ...
  `idC` int(11) DEFAULT NULL,
  `max_supplements` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO users VALUES(37,1002,"lucacampisi@gmail.com","4a61df2efbaa659c0badc65c6febb2ac","39","3291844484","","726577",1,"image/user.png","image/user_high.png","2013-11-28 13:46:03");
